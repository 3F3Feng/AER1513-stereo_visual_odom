function [matchedPts1, matchedPts2, fea_ord_1, fea_ord_2,err] = matchfeatures_SURF(features_1,features_2,thsErr)
...
%   Inputs:
%   -------
%   features1   - OpenSurf features for image 1 (class: 'struct')
%   features2   - OpenSurf features for image 2 (class: 'struct'
%
%   Outputs:
%   -------
%   matchedPts1    - x,y coordinates of matched points in image 1
